...
final class SOM_Free_Downloads {
	 ...
	 * @var string
	 */
	private $name = 'Free Downloads WooCommerce';
	 ...
	 * @var string
	 */
	private $db_setting = 'somdn_woo_plugin_db_version';
	...
	private function check_requirements() {
		...
		if ( $can_do_check == true ) {
			$requirements_check = new SOMDN_WOO_Requirements( $this->requirements_data );
	...
	private function set_requirements_data() {
		...
		$this->requirements = array(
			$woocommerce_plugin = array(
				'type_id' => 'wp_plugin',
				'type_name' => __( 'WordPress Plugin', 'download-now-for-woocommerce' ),
				'name' => 'WooCommerce',
			...
			$php_version_check = array(
				'type_id' => 'php_min_ver',
				'type_name' => __( 'Minimum PHP Version', 'download-now-for-woocommerce' ),
				'name' => 'Version 5.6.0',
...
function somdn() {
	return SOM_Free_Downloads::instance();
}
